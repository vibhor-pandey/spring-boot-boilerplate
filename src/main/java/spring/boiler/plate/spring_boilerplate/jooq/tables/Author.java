 ...
 */
package spring.boiler.plate.spring_boilerplate.jooq.tables;
...
import spring.boiler.plate.spring_boilerplate.jooq.Keys;
import spring.boiler.plate.spring_boilerplate.jooq.Public;
...
public class Author extends TableImpl<AuthorRecord> {
     ...
     */
    public final TableField<AuthorRecord, LocalDate> BIRTHDAY = createField(DSL.name("birthday"), SQLDataType.LOCALDATE.nullable(false), this, "");

    /**
     * The column <code>public.author.country</code>.
     */
    public final TableField<AuthorRecord, String> COUNTRY = createField(DSL.name("country"), SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>public.author.writing_hrs_per_day</code>.
     */
    public final TableField<AuthorRecord, Integer> WRITING_HRS_PER_DAY = createField(DSL.name("writing_hrs_per_day"), SQLDataType.INTEGER.nullable(false), this, "");
